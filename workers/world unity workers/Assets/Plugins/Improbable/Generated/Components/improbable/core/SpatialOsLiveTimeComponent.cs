...
{
    public class SpatialOsLiveTimeComponent: SpatialOsComponentBase
    {
        /// <inheritdoc />
        public override uint ComponentId { get { return 1006; } }
        ...
        {
            OnAddComponentDispatcherCallback(new AddComponentOp<global::Improbable.Core.LiveTime> { EntityId = entityId, Data = new global::Improbable.Core.LiveTime.Data(((global::Improbable.Core.LiveTime.Impl)op.ComponentObject).Data) });
        }

        /// <inheritdoc />
        public override void OnComponentUpdatePipelineOp(UpdateComponentPipelineOp op)
        {
            OnComponentUpdateDispatcherCallback(new ComponentUpdateOp<global::Improbable.Core.LiveTime> { EntityId = entityId, Update = (global::Improbable.Core.LiveTime.Update)op.UpdateObject });
        }

        protected void OnAddComponentDispatcherCallback(AddComponentOp<global::Improbable.Core.LiveTime> op)
        {
        ...
        /// </summary>
        public virtual void SendComponentUpdate(global::Improbable.Core.LiveTime.Update update)
        {
		...
		{
		    communicator.SendAuthorityLossImminentAcknowledgement<global::Improbable.Core.LiveTime>(entityId);
		}

        /// <summary>
        ///     The type of callback to listen for component updates.
        /// </summary>
        public delegate void OnComponentUpdateCallback(global::Improbable.Core.LiveTime.Update update);
        ...
        protected void OnComponentUpdateDispatcherCallback(
            global::Improbable.Worker.ComponentUpdateOp<global::Improbable.Core.LiveTime> op)
        {
            if (op.EntityId != entityId)
            {
                return;
        ...
        protected void OnComponentUpdateDispatcherCallback(global::Improbable.Core.LiveTime.Update update) {
