...
{
    [CustomEditor(typeof(SpatialOsCollisionsCreatedComponent))]
    public class SpatialOsCollisionsCreatedComponentEditor : UnityEditor.Editor
    {
        private SpatialOsCollisionsCreatedComponent editedComponent;
        private SpatialOsCollisionsCreatedComponentEditorData componentData;

        private class SpatialOsCollisionsCreatedComponentEditorData : SpatialOsComponentEditorBase<SpatialOsCollisionsCreatedComponent>
        {        }

        protected virtual void OnEnable()
        {
            editedComponent = (SpatialOsCollisionsCreatedComponent) target;

            var hashCode = editedComponent.GetHashCode();
            componentData = (SpatialOsCollisionsCreatedComponentEditorData) EditorObjectStateManager.GetComponentEditorData(hashCode);
            if(componentData == null)
            {
                componentData = new SpatialOsCollisionsCreatedComponentEditorData();
