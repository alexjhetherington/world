...
{
    [CustomEditor(typeof(SpatialOsMessageSpawnerComponent))]
    public class SpatialOsMessageSpawnerComponentEditor : UnityEditor.Editor
    {
        private SpatialOsMessageSpawnerComponent editedComponent;
        private SpatialOsMessageSpawnerComponentEditorData componentData;

        private class SpatialOsMessageSpawnerComponentEditorData : SpatialOsComponentEditorBase<SpatialOsMessageSpawnerComponent>
        {        }

        protected virtual void OnEnable()
        {
            editedComponent = (SpatialOsMessageSpawnerComponent) target;

            var hashCode = editedComponent.GetHashCode();
            componentData = (SpatialOsMessageSpawnerComponentEditorData) EditorObjectStateManager.GetComponentEditorData(hashCode);
            if(componentData == null)
            {
                componentData = new SpatialOsMessageSpawnerComponentEditorData();
