...
{
    [CustomEditor(typeof(SpatialOsMessageComponent))]
    public class SpatialOsMessageComponentEditor : UnityEditor.Editor
    {
        private SpatialOsMessageComponent editedComponent;
        private SpatialOsMessageComponentEditorData componentData;

        private class SpatialOsMessageComponentEditorData : SpatialOsComponentEditorBase<SpatialOsMessageComponent>
        {
        ...
        {
            editedComponent = (SpatialOsMessageComponent) target;

            var hashCode = editedComponent.GetHashCode();
            componentData = (SpatialOsMessageComponentEditorData) EditorObjectStateManager.GetComponentEditorData(hashCode);
            if(componentData == null)
            {
                componentData = new SpatialOsMessageComponentEditorData();
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.Space();
            EditorGUILayout.TextField("message", componentData.Message);
