...
{
    [CustomEditor(typeof(SpatialOsLiveTimeComponent))]
    public class SpatialOsLiveTimeComponentEditor : UnityEditor.Editor
    {
        private SpatialOsLiveTimeComponent editedComponent;
        private SpatialOsLiveTimeComponentEditorData componentData;

        private class SpatialOsLiveTimeComponentEditorData : SpatialOsComponentEditorBase<SpatialOsLiveTimeComponent>
        {
        ...
        {
            editedComponent = (SpatialOsLiveTimeComponent) target;

            var hashCode = editedComponent.GetHashCode();
            componentData = (SpatialOsLiveTimeComponentEditorData) EditorObjectStateManager.GetComponentEditorData(hashCode);
            if(componentData == null)
            {
                componentData = new SpatialOsLiveTimeComponentEditorData();
