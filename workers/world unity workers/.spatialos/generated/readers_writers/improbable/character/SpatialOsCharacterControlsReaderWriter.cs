...
/// <summary>
/// CharacterControlsWriter is deprecated and will be removed in a future SpatialOS version. Please migrate to the simplified
/// <c>CharacterControls.Writer</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.WriterInterface]
[global::Improbable.Entity.Component.ComponentId(1000)]
[global::System.Obsolete("Please use CharacterControls.Writer (but see its documentation for semantic differences).")]
public interface CharacterControlsWriter : CharacterControlsReader
{
  CharacterControls.Updater Update { get; }
}

/// <summary>
/// CharacterControlsReader is deprecated and will be removed in a future SpatialOS version. Please migrate to the simplified
/// <c>CharacterControls.Reader</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.ReaderInterface]
[global::Improbable.Entity.Component.ComponentId(1000)]
[global::System.Obsolete("Please use CharacterControls.Reader (but see its documentation for semantic differences).")]
public interface CharacterControlsReader
{
  ...
  // Field characterControls = 1.
  global::Improbable.Collections.List<global::Improbable.Character.CharacterControlsUpdate> CharacterControls { get; }
  event global::System.Action<global::Improbable.Collections.List<global::Improbable.Character.CharacterControlsUpdate>> CharacterControlsUpdated;
}

public partial class CharacterControls : global::Improbable.Entity.Component.IComponentFactory
{
  [global::Improbable.Entity.Component.WriterInterface]
  [global::Improbable.Entity.Component.ComponentId(1000)]
  public interface Writer : Reader, global::Improbable.Entity.Component.IComponentWriter
  {
    ...
    /// </summary>
    /// <remarks>
    /// Unlike the deprecated <c>CharacterControlsWriter</c> interface, changes made by the update are not
  ...
  public interface Reader
  {
    ...
    /// </summary>
    global::Improbable.Character.CharacterControlsData Data { get; }
    ...
    /// <summary>
    /// Register callbacks here to be invoked whenever characterControls field value is changed.
    /// </summary>
    global::Improbable.Entity.Component.PropertyCallbackHandler<global::Improbable.Collections.List<global::Improbable.Character.CharacterControlsUpdate>> CharacterControlsUpdated { get; set; }
  }

  /// <summary>
  /// CharacterControls.Updater is deprecated and will be removed in a future SpatialOS version.
  /// Please use CharacterControls.Writer.Send() instead (see the documentation for semantic differences).
  /// </summary>
  [global::System.Obsolete("Please use CharacterControls.Writer.Send() instead (see the documentation for semantic differences).")]
  public interface Updater
  {
    ...
    Updater CharacterControls(global::System.Collections.Generic.IList<global::Improbable.Character.CharacterControlsUpdate> newValue);
  ...
  {
    dispatcher.OnAddComponent<CharacterControls>((op) => {
      ...
      else if (!loggedInvalidAddComponent)
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component CharacterControls added to entity " + op.EntityId + ", but it already exists." +
            "This error will be reported once only for each component."));
        loggedInvalidAddComponent = true;
      }
    });

    dispatcher.OnRemoveComponent<CharacterControls>((op) => {
      Impl impl;
      ...
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component CharacterControls removed from entity " + op.EntityId + ", but it does not exist." +
            "This error will be reported once only for each component."));
        loggedInvalidRemoveComponent = true;
      }
    });

    dispatcher.OnAuthorityChange<CharacterControls>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
    ...
    dispatcher.OnComponentUpdate<CharacterControls>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
  ...
  #pragma warning disable 0618
  public class Impl : CharacterControlsWriter, Writer, Updater
  #pragma warning restore 0618
  {
    ...
    public Impl(global::Improbable.Worker.Connection connection, global::Improbable.EntityId entityId, Data initialData)
    {
      ...
      characterControlsUpdateHandler =
        new global::Improbable.Entity.Component.PropertyCallbackHandler<global::Improbable.Collections.List<global::Improbable.Character.CharacterControlsUpdate>>(() => data.Value.characterControls);
    }
    ...
    public global::Improbable.Character.CharacterControlsData Data
    {
	...
	{
	  connection.SendAuthorityLossImminentAcknowledgement<CharacterControls>(entityId);
	}
    ...
    private global::Improbable.Entity.Component.PropertyCallbackHandler<global::Improbable.Collections.List<global::Improbable.Character.CharacterControlsUpdate>> characterControlsUpdateHandler;

    public global::Improbable.Entity.Component.PropertyCallbackHandler<global::Improbable.Collections.List<global::Improbable.Character.CharacterControlsUpdate>> CharacterControlsUpdated
    {
      get { return characterControlsUpdateHandler; }
	    set { characterControlsUpdateHandler = value; }
    }
    ...
    private void TriggerCallbacks(Update update)
    {
      ...
      {
        characterControlsUpdateHandler.InvokeCallbacks(update.characterControls.Value);
      }
    }
    ...
    private CharacterControls.Update currentUpdate = null;
    ...
    #pragma warning restore 0618
    {
      get
      {
        ...
        {
          currentUpdate = new CharacterControls.Update();
        }
        else
        {
          global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
              "Update for component CharacterControls called with an update already in-flight! " +
    ...
    #pragma warning disable 0618
    event global::System.Action<global::Improbable.Worker.Authority> CharacterControlsReader.AuthorityChanged
    #pragma warning restore 0618
    {
    ...
    {
      get { return Data.characterControls; }
    }

    private static global::System.Action<Update> CharacterControlsUpdated_Wrap(global::System.Action<global::Improbable.Collections.List<global::Improbable.Character.CharacterControlsUpdate>> action)
    {
      return (update) => { if (update.characterControls.HasValue) { action(update.characterControls.Value); } };
    }

    #pragma warning disable 0618
    event global::System.Action<global::Improbable.Collections.List<global::Improbable.Character.CharacterControlsUpdate>> CharacterControlsReader.CharacterControlsUpdated
    #pragma warning restore 0618
    {
      add { ComponentUpdated.Add(CallbackConversionMemoiser.Add<global::System.Action<global::Improbable.Collections.List<global::Improbable.Character.CharacterControlsUpdate>>, global::System.Action<Update>>(CharacterControlsUpdated_Wrap, value)); value(Data.characterControls); }
      remove { ComponentUpdated.Remove(CallbackConversionMemoiser.Remove<global::System.Action<global::Improbable.Collections.List<global::Improbable.Character.CharacterControlsUpdate>>, global::System.Action<Update>>(CharacterControlsUpdated_Wrap, value)); }
    }

    #pragma warning disable 0618
    Updater Updater.CharacterControls(global::System.Collections.Generic.IList<global::Improbable.Character.CharacterControlsUpdate> newValue)
    #pragma warning restore 0618
    {
      currentUpdate.SetCharacterControls(new global::Improbable.Collections.List<global::Improbable.Character.CharacterControlsUpdate>(newValue));
      return this;
    }
    private bool FinishAndSend_ResolveDiff(Update update)
    {
      ...
      if (update.characterControls.HasValue)
      {
        if (update.characterControls.Value == Data.characterControls)
        {
          update.characterControls.Clear();
        }
        else
        {
          isNoOp = false;
