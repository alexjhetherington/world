...
/// <summary>
/// ClientAuthorityCheckWriter is deprecated and will be removed in a future SpatialOS version. Please migrate to the simplified
/// <c>ClientAuthorityCheck.Writer</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.WriterInterface]
[global::Improbable.Entity.Component.ComponentId(1002)]
[global::System.Obsolete("Please use ClientAuthorityCheck.Writer (but see its documentation for semantic differences).")]
public interface ClientAuthorityCheckWriter : ClientAuthorityCheckReader
{
  ClientAuthorityCheck.Updater Update { get; }
}

/// <summary>
/// ClientAuthorityCheckReader is deprecated and will be removed in a future SpatialOS version. Please migrate to the simplified
/// <c>ClientAuthorityCheck.Reader</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.ReaderInterface]
[global::Improbable.Entity.Component.ComponentId(1002)]
[global::System.Obsolete("Please use ClientAuthorityCheck.Reader (but see its documentation for semantic differences).")]
public interface ClientAuthorityCheckReader
{
...
public partial class ClientAuthorityCheck : global::Improbable.Entity.Component.IComponentFactory
{
  [global::Improbable.Entity.Component.WriterInterface]
  [global::Improbable.Entity.Component.ComponentId(1002)]
  public interface Writer : Reader, global::Improbable.Entity.Component.IComponentWriter
  {
    ...
    /// </summary>
    /// <remarks>
    /// Unlike the deprecated <c>ClientAuthorityCheckWriter</c> interface, changes made by the update are not
  ...
  public interface Reader
  {
    ...
    /// </summary>
    global::Improbable.Core.ClientAuthorityCheckData Data { get; }
  ...
  /// <summary>
  /// ClientAuthorityCheck.Updater is deprecated and will be removed in a future SpatialOS version.
  /// Please use ClientAuthorityCheck.Writer.Send() instead (see the documentation for semantic differences).
  /// </summary>
  [global::System.Obsolete("Please use ClientAuthorityCheck.Writer.Send() instead (see the documentation for semantic differences).")]
  ...
  {
    dispatcher.OnAddComponent<ClientAuthorityCheck>((op) => {
      ...
      else if (!loggedInvalidAddComponent)
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component ClientAuthorityCheck added to entity " + op.EntityId + ", but it already exists." +
            "This error will be reported once only for each component."));
        loggedInvalidAddComponent = true;
      }
    });

    dispatcher.OnRemoveComponent<ClientAuthorityCheck>((op) => {
      Impl impl;
      ...
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component ClientAuthorityCheck removed from entity " + op.EntityId + ", but it does not exist." +
            "This error will be reported once only for each component."));
        loggedInvalidRemoveComponent = true;
      }
    });

    dispatcher.OnAuthorityChange<ClientAuthorityCheck>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
    ...
    dispatcher.OnComponentUpdate<ClientAuthorityCheck>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
  ...
  public class Impl : ClientAuthorityCheckWriter, Writer, Updater
  #pragma warning restore 0618
  {
    ...
    public global::Improbable.Core.ClientAuthorityCheckData Data
    {
	...
	{
	  connection.SendAuthorityLossImminentAcknowledgement<ClientAuthorityCheck>(entityId);
	}
    ...
    private ClientAuthorityCheck.Update currentUpdate = null;
    ...
    #pragma warning restore 0618
    {
      get
      {
        ...
        {
          currentUpdate = new ClientAuthorityCheck.Update();
        }
        else
        {
          global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
              "Update for component ClientAuthorityCheck called with an update already in-flight! " +
    ...
    #pragma warning disable 0618
    event global::System.Action<global::Improbable.Worker.Authority> ClientAuthorityCheckReader.AuthorityChanged
    #pragma warning restore 0618
    {
