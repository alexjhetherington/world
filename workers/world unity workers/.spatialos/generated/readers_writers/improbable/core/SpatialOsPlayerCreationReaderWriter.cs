...
/// <summary>
/// PlayerCreationWriter is deprecated and will be removed in a future SpatialOS version. Please migrate to the simplified
/// <c>PlayerCreation.Writer</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.WriterInterface]
[global::Improbable.Entity.Component.ComponentId(1001)]
[global::System.Obsolete("Please use PlayerCreation.Writer (but see its documentation for semantic differences).")]
public interface PlayerCreationWriter : PlayerCreationReader
{
  PlayerCreation.Updater Update { get; }
}

/// <summary>
/// PlayerCreationReader is deprecated and will be removed in a future SpatialOS version. Please migrate to the simplified
/// <c>PlayerCreation.Reader</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.ReaderInterface]
[global::Improbable.Entity.Component.ComponentId(1001)]
[global::System.Obsolete("Please use PlayerCreation.Reader (but see its documentation for semantic differences).")]
public interface PlayerCreationReader
{
...
public partial class PlayerCreation : global::Improbable.Entity.Component.IComponentFactory
{
  [global::Improbable.Entity.Component.WriterInterface]
  [global::Improbable.Entity.Component.ComponentId(1001)]
  public interface Writer : Reader, global::Improbable.Entity.Component.IComponentWriter
  {
    ...
    /// </summary>
    /// <remarks>
    /// Unlike the deprecated <c>PlayerCreationWriter</c> interface, changes made by the update are not
  ...
  public interface Reader
  {
    ...
    /// </summary>
    global::Improbable.Core.PlayerCreationData Data { get; }
  ...
  /// <summary>
  /// PlayerCreation.Updater is deprecated and will be removed in a future SpatialOS version.
  /// Please use PlayerCreation.Writer.Send() instead (see the documentation for semantic differences).
  /// </summary>
  [global::System.Obsolete("Please use PlayerCreation.Writer.Send() instead (see the documentation for semantic differences).")]
  ...
  public interface ICommandReceiver
  {
      global::Improbable.Entity.Component.CommandResponderWrapper<
        global::Improbable.Core.PlayerCreation.Commands.CreatePlayer,
  ...
  public partial class Commands
  {
    public partial class CreatePlayer
    {
            ...
            global::Improbable.Core.CreatePlayerResponse>
      {
        ...
        CreateRequest = request => new global::Improbable.Core.PlayerCreation.Commands.CreatePlayer.Request(request),
        CreateResponse = response => new global::Improbable.Core.PlayerCreation.Commands.CreatePlayer.Response(response),
  ...
  {
    dispatcher.OnAddComponent<PlayerCreation>((op) => {
      ...
      else if (!loggedInvalidAddComponent)
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component PlayerCreation added to entity " + op.EntityId + ", but it already exists." +
            "This error will be reported once only for each component."));
        loggedInvalidAddComponent = true;
      }
    });

    dispatcher.OnRemoveComponent<PlayerCreation>((op) => {
      Impl impl;
      ...
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component PlayerCreation removed from entity " + op.EntityId + ", but it does not exist." +
            "This error will be reported once only for each component."));
        loggedInvalidRemoveComponent = true;
      }
    });

    dispatcher.OnAuthorityChange<PlayerCreation>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
    ...
    dispatcher.OnComponentUpdate<PlayerCreation>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
  ...
  public class Impl : PlayerCreationWriter, Writer, Updater
  #pragma warning restore 0618
  {
    ...
    public global::Improbable.Core.PlayerCreationData Data
    {
	...
	{
	  connection.SendAuthorityLossImminentAcknowledgement<PlayerCreation>(entityId);
	}
    ...
    private PlayerCreation.Update currentUpdate = null;
    ...
    #pragma warning restore 0618
    {
      get
      {
        ...
        {
          currentUpdate = new PlayerCreation.Update();
        }
        else
        {
          global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
              "Update for component PlayerCreation called with an update already in-flight! " +
    ...
    #pragma warning disable 0618
    event global::System.Action<global::Improbable.Worker.Authority> PlayerCreationReader.AuthorityChanged
    #pragma warning restore 0618
    {
