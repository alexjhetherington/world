...
[global::Improbable.Entity.Component.ComponentId(1004)]
...
public partial class Rotation : global::Improbable.Entity.Component.IComponentFactory
{
  ...
  public interface Reader
  {
    ...
    /// </summary>
    global::Improbable.Entity.Component.PropertyCallbackHandler<uint> RotationUpdated { get; set; }
  }
  ...
  #pragma warning restore 0618
  {
    ...
    public uint ComponentId { get { return 1004; } }
    ...
    public Impl(global::Improbable.Worker.Connection connection, global::Improbable.EntityId entityId, Data initialData)
    {
      ...
      rotationUpdateHandler =
        new global::Improbable.Entity.Component.PropertyCallbackHandler<uint>(() => data.Value.rotation);
    }
	...
	{
	  connection.SendAuthorityLossImminentAcknowledgement<Rotation>(entityId);
	}
    ...
    private global::Improbable.Entity.Component.PropertyCallbackHandler<uint> rotationUpdateHandler;

    public global::Improbable.Entity.Component.PropertyCallbackHandler<uint> RotationUpdated
    {
      get { return rotationUpdateHandler; }
	    set { rotationUpdateHandler = value; }
    }
    ...
    private void TriggerCallbacks(Update update)
    {
      ...
      {
        rotationUpdateHandler.InvokeCallbacks(update.rotation.Value);
      }
    }
    ...
    #pragma warning disable 0618
    event global::System.Action<global::Improbable.Worker.Authority> RotationReader.AuthorityChanged
    #pragma warning restore 0618
    {
    ...
    #pragma warning disable 0618
    event global::System.Action<uint> RotationReader.RotationUpdated
    #pragma warning restore 0618
    {
      add { ComponentUpdated.Add(CallbackConversionMemoiser.Add<global::System.Action<uint>, global::System.Action<Update>>(RotationUpdated_Wrap, value)); value(Data.rotation); }
      remove { ComponentUpdated.Remove(CallbackConversionMemoiser.Remove<global::System.Action<uint>, global::System.Action<Update>>(RotationUpdated_Wrap, value)); }
    }
