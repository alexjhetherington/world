...
/// <summary>
/// LiveTimeWriter is deprecated and will be removed in a future SpatialOS version. Please migrate to the simplified
/// <c>LiveTime.Writer</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.WriterInterface]
[global::Improbable.Entity.Component.ComponentId(1006)]
[global::System.Obsolete("Please use LiveTime.Writer (but see its documentation for semantic differences).")]
public interface LiveTimeWriter : LiveTimeReader
{
  LiveTime.Updater Update { get; }
}

/// <summary>
/// LiveTimeReader is deprecated and will be removed in a future SpatialOS version. Please migrate to the simplified
/// <c>LiveTime.Reader</c> interface (but see its documentation for semantic differences).
/// </summary>
[global::Improbable.Entity.Component.ReaderInterface]
[global::Improbable.Entity.Component.ComponentId(1006)]
[global::System.Obsolete("Please use LiveTime.Reader (but see its documentation for semantic differences).")]
public interface LiveTimeReader
{
...
public partial class LiveTime : global::Improbable.Entity.Component.IComponentFactory
{
  [global::Improbable.Entity.Component.WriterInterface]
  [global::Improbable.Entity.Component.ComponentId(1006)]
  public interface Writer : Reader, global::Improbable.Entity.Component.IComponentWriter
  {
    ...
    /// </summary>
    /// <remarks>
    /// Unlike the deprecated <c>LiveTimeWriter</c> interface, changes made by the update are not
  ...
  public interface Reader
  {
    ...
    /// </summary>
    global::Improbable.Core.LiveTimeData Data { get; }
  ...
  /// <summary>
  /// LiveTime.Updater is deprecated and will be removed in a future SpatialOS version.
  /// Please use LiveTime.Writer.Send() instead (see the documentation for semantic differences).
  /// </summary>
  [global::System.Obsolete("Please use LiveTime.Writer.Send() instead (see the documentation for semantic differences).")]
  ...
  {
    dispatcher.OnAddComponent<LiveTime>((op) => {
      ...
      else if (!loggedInvalidAddComponent)
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component LiveTime added to entity " + op.EntityId + ", but it already exists." +
            "This error will be reported once only for each component."));
        loggedInvalidAddComponent = true;
      }
    });

    dispatcher.OnRemoveComponent<LiveTime>((op) => {
      Impl impl;
      ...
      {
        global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
            "Component LiveTime removed from entity " + op.EntityId + ", but it does not exist." +
            "This error will be reported once only for each component."));
        loggedInvalidRemoveComponent = true;
      }
    });

    dispatcher.OnAuthorityChange<LiveTime>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
    ...
    dispatcher.OnComponentUpdate<LiveTime>((op) => {
      Impl impl;
      if (implMap.TryGetValue(op.EntityId, out impl))
      {
  ...
  #pragma warning disable 0618
  public class Impl : LiveTimeWriter, Writer, Updater
  #pragma warning restore 0618
  {
    ...
    public uint ComponentId { get { return 1006; } }
    ...
    public global::Improbable.Core.LiveTimeData Data
    {
	...
	{
	  connection.SendAuthorityLossImminentAcknowledgement<LiveTime>(entityId);
	}
    ...
    private LiveTime.Update currentUpdate = null;
    ...
    #pragma warning restore 0618
    {
      get
      {
        ...
        {
          currentUpdate = new LiveTime.Update();
        }
        else
        {
          global::Improbable.Worker.ClientError.LogClientException(new global::System.InvalidOperationException(
              "Update for component LiveTime called with an update already in-flight! " +
    ...
    #pragma warning disable 0618
    event global::System.Action<global::Improbable.Worker.Authority> LiveTimeReader.AuthorityChanged
    #pragma warning restore 0618
    {
    ...
    #pragma warning disable 0618
    event global::System.Action<float> LiveTimeReader.TimestampUpdated
    #pragma warning restore 0618
    {
